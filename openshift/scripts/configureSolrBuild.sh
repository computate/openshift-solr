...
-v NAME=${BUILD_NAME} \
-v GIT_REPO_URL=${GIT_URI} \
-v GIT_REF=${GIT_REF} \
-v SOURCE_CONTEXT_DIR=${SOURCE_CONTEXT_DIR} \
-v SOURCE_IMAGE_NAME=${SOURCE_IMAGE_NAME} \
-v SOURCE_IMAGE_TAG=${SOURCE_IMAGE_TAG} \
-v SOURCE_IMAGE_NAMESPACE=${SOURCE_IMAGE_NAMESPACE} \
-v OUTPUT_IMAGE_TAG=${OUTPUT_IMAGE_TAG} \
> ${BUILD_CONFIG}
